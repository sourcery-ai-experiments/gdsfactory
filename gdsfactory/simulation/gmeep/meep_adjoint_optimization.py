...
def get_meep_adjoint_optimizer(
    ...
    **settings,
    ...
    for design_region, design_variable in zip(design_regions, design_variables):
        ...
        block = c << gf.pcells.rectangle((design_region.size[0], design_region.size[1]))
