...
def get_bundle(
    ...
    **kwargs,
    ...
    """
    if separation is None and cross_section is not None:
        xs = (
...
if __name__ == "__main__":
    ...
    routes = get_bundle(
        ...
        straight=partial(gf.components.straight, width=1, cross_section="xs_rc"),
        bend=partial(gf.components.straight, width=1, cross_section="xs_rc"),
        cross_section=None,
    )
    for route in routes:
        c.add(route.references)
