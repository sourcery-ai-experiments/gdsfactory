...
The connect command allows you to connect Instance ports together like
Lego blocks.
...
if __name__ == "__main__":
    ...
    wg1 = c << gf.pcells.straight(length=10, width=1)
    wg2 = c << gf.pcells.straight(length=10, width=2, layer=gf.LAYER.SLAB90)
    wg3 = c << gf.pcells.straight(length=10, width=3, layer=gf.LAYER.SLAB150)
