...
def component_sequence(
    ...
    Returns:
        component: containing the sequence of sub-pcells
    ...
    .. plot::
        ...
        s = "AB-H-H-H-H-BA"
        c = gf.pcells.component_sequence(sequence=s, symbol_to_component=symbol_to_component)
        c.plot()
    """
...
if __name__ == "__main__":
    ...
    c = gf.pcells.component_sequence(
