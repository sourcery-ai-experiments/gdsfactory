...
def mmi1x2_with_sbend(
    ...
    input_port_ref = c << gf.pcells.straight(length=0.25, cross_section=cross_section)
    input_port_ref.center = (-0.125, 0)
    top_output_port_ref = c << gf.pcells.straight(
        length=0.25, cross_section=cross_section
    )
    top_output_port_ref.center = (2.125, 0.35)
    bottom_output_port_ref = c << gf.pcells.straight(
        length=0.25, cross_section=cross_section
    )
