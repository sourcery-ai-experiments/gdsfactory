...
from gdsfactory.pcells.bezier import (
    bezier,
    bezier_curve,
...
def compensation_path(
    ...
    Args:
        crossing45: component that we want to match in path length.
            needs to have .info["pcells"] with bends and crossing.
...
def _demo() -> None:
    ...
    bend_info1 = c.info["pcells"]["bezier_bend"].info
    bend_info2 = c2.info["pcells"]["sbend"].info
