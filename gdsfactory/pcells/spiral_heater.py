...
from gdsfactory.pcells.bend_s import bend_s, get_min_sbend_size
...
def spiral_racetrack_heater_metal(
    ...
    heater_bend = c << gf.pcells.bend_circular(
        angle=180,
...
def spiral_racetrack_heater_doped(
    ...
    heater_straight = gf.pcells.straight(
        straight_length, cross_section=heater_cross_section
    )
