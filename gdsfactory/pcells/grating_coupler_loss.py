...
from gdsfactory.pcells.add_labels import get_input_label as get_input_label_function
...
def connect_loopback(
    ...
    **kwargs,
    ...
    bend90 = gf.pcells.bend_euler(cross_section=cross_section, **kwargs)
    return round_corners(
        points=points,
        bend=bend90,
        straight=gf.pcells.straight,
