    ...
    for port in ports_all:
        ...
        if port_name in ports_to_extend_names:
            if extension:
                ...
                extension_component = gf.pcells.straight(
                    length=length,
...
def test_extend_ports() -> Component:
    import gdsfactory.pcells as pc
...
if __name__ == "__main__":
    # c0 = gf.pcells.taper(width2=10)
    extension = gf.pcells.straight_heater_meander()
    ...
    # c = extend_ports(gf.pcells.mzi_phase_shifter_top_heater_metal)
    # c = test_extend_ports()
