...
def taper(
    ...
    **kwargs,
    ...
    Deprecated, use gf.pcells.taper_cross_section instead
...
def taper_strip_to_ridge_trenches(
    ...
    c.add_port(name="o1", center=(0, 0), width=width, angle=180, layer=layer_wg)
    c.add_port(name="o2", center=(length, 0), width=width, angle=0, layer=layer_wg)
    return c
...
if __name__ == "__main__":
    ...
    # c = taper()
    # c = gf.pcells.taper_strip_to_ridge(width1=1, width2=2)
    # c = gf.pcells.taper_strip_to_ridge(width1=1, width2=2)
    # c = gf.pcells.extend_ports(c)
    # c = taper_strip_to_ridge_trenches()
    # c = taper()
    # c = taper_sc_nc()
