...
def delay_snake2(
    ...
    **kwargs,
    ...
    s1 = gf.pcells.straight(length=length1, cross_section=cross_section, **kwargs)
    s2 = gf.pcells.straight(length=length2, cross_section=cross_section, **kwargs)
    sd = gf.pcells.straight(cross_section=cross_section, length=delta_length, **kwargs)
    ...
    sequence = sequence[:-1]
    sequence += "."
    return gf.pcells.component_sequence(
