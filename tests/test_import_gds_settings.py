...
pcells_to_test = set(cells.keys()) - skip_test
...
# @pytest.mark.parametrize("component_type", pcells_to_test)
# def test_properties_pcells(component_type: str) -> Component:
...
pass
# c = test_properties_pcells(component_type=list(component_names)[0])
# c = test_properties_pcells(component_type="ring_single")
# c = test_properties_pcells(component_type="mzit")
# c = test_properties_pcells(component_type="bezier")
# c = test_properties_pcells(component_type="wire_straight")
# c = test_properties_pcells(component_type="straight")
# c = test_properties_pcells(component_type="grating_coupler_tree")
# c = test_properties_pcells(component_type="wire")
# c = test_properties_pcells(component_type="bend_circular")
# c = test_properties_pcells(component_type="mzi_arm")
# c = test_properties_pcells(component_type="straight_pin")
