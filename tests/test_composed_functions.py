...
extend_ports1 = gf.partial(gf.pcells.extend_ports, length=1)
extend_ports2 = gf.partial(gf.pcells.extend_ports, length=10)


straigth_extended1 = toolz.compose(
    extend_ports1, gf.partial(gf.pcells.straight, width=0.5)
)
straigth_extended2 = toolz.compose(
    extend_ports2, gf.partial(gf.pcells.straight, width=0.9)
)
straigth_extended3 = toolz.compose(
    extend_ports2, gf.partial(gf.pcells.straight, width=0.5)
)
...
def test_compose1() -> None:
    ...
    # mzi500 = gf.partial(gf.pcells.mzi, straight=straigth_extended1)
    # mzi900 = gf.partial(gf.pcells.mzi, straight=straigth_extended2)
    # c500 = mzi500()
    # c900 = mzi900()
...
#     """
#     mzi500 = gf.partial(gf.pcells.mzi, straight=straigth_extended3)
#     mzi900 = gf.partial(gf.pcells.mzi, straight=straigth_extended2)
